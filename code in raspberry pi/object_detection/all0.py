...
class Hx711():
    ...
    def weigh(self):
        ...
        if self.flag==1:
            ...
            self.weight = 1.8*self.weight/1905.0-2.2
            return self.weight
            #if(self.weight > 200):
...
if camera_type == 'picamera':
    ...
    for frame1 in camera.capture_continuous(rawCapture, format="bgr",use_video_port=True):
        ...
        elif(classes[0][0]==1 and scores[0][0]*100 >= 50):
